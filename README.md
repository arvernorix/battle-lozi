...
~~~sh
# getting the code
git clone git@github.com:nko4/lozi.git && cd ./lozi/
...
# ssh access
ssh deploy@lozi.2013.nodeknockout.com
ssh root@lozi.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@lozi.2013.nodeknockout.com
ssh -i ./id_deploy root@lozi.2013.nodeknockout.com
~~~
